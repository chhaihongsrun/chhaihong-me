<template>
  <div class="flex flex-col h-full p-5">
    <header class="h-100">
      <h1 class="text-2xl text-gray-700 lg:text-4xl">{{ $static.metadata.siteName }}</h1>
      <p class="text-base font-light text-gray-600">Lucky is plan meets opportunity!</p>
      <nav class="mt-8 nav">
        <g-link class="px-6 py-1 mr-3 leading-none text-gray-400 border border-orange-700 rounded-lg" to="/">Home</g-link>
        <g-link class="px-6 py-1 mr-3 leading-none text-gray-400 border border-orange-700 rounded-lg" to="/metadata">Metadata</g-link>
      </nav>
    </header>
    ...
    <footer class="mt-auto">
      <ul class="flex items-center my-6">
        <li class="mr-3">
          <a href="https://github.com/chhaihongsrun/" target="_blank" class="text-gray-700 hover:text-gray-600">
        ...
        <li class="mr-3">
          <a href="https://twitter.com/srun_chhaihong/" target="_blank" class="text-gray-700 hover:text-gray-600">
        ...
        <li class="mr-3">
          <a href="https://www.youtube.com/c/ChhaihongSrun/" target="_blank" class="text-gray-700 hover:text-gray-600">
